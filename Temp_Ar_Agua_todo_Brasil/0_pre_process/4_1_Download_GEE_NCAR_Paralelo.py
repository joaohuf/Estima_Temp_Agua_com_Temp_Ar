...
# Faz o download dos dados de temperatura do ar do modelo NCAR através do Google Earth Engine
...
def Run_all(dates):
    ...
    pixels_timeserie = pixels_values(dataset, points_shp, "air", id_name='Codigo')
...
Dir_save = 'E:\\Artigos\\Artigo_Temp_Ar_Agua\\Dados_temp\\Bruto_GEE\\NCAR\\'
part = 'A'
f_save = f'{Dir_save}NCAR_{part}'
