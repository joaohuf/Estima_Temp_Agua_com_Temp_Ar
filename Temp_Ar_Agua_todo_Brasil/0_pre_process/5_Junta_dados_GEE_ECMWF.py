...
# Reorganiza os dados do modelo ECMWF baixados do GEE
...
Dir = 'E:\\Artigos\\Artigo_Temp_Ar_Agua\\Dados_temp\\Bruto_GEE\\ECMWF\\'
...
dt.to_csv(f'{Dir_save}Temp_Ar_ECMWF.txt', sep='\t')
