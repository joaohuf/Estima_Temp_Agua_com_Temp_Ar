...
# Reorganiza os dados do modelo NCAR baixados do GEE
...
Dir = 'E:\\Artigos\\Artigo_Temp_Ar_Agua\\Dados_temp\\Bruto_GEE\\NCAR\\'
...
dt.to_csv(f'{Dir_save}Temp_Ar_NCAR.txt', sep='\t')
