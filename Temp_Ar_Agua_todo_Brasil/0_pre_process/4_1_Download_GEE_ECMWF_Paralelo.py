...
# Faz o download dos dados de temperatura do ar do modelo ECMWF através do Google Earth Engine
...
Dir_save = 'E:\\Artigos\\Artigo_Temp_Ar_Agua\\Dados_temp\\Bruto_GEE\\ECMWF\\'
part = 'A'
f_save = f'{Dir_save}ECMWF_{part}'
